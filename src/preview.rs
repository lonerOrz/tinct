...
pub fn show_color_preview(theme_path: &str, mode: &str) -> Result<(), String> {
    ...
    println!("{}", "🎨 Material Design 3 Color Preview".bold().underline());
...
fn display_md3_cards_grid(palette: &crate::theme::Palette) {
    ...
    let cards = vec![
        ...
        vec![
            ...
            ("On Primary Container", &palette.on_primary_container.default),
        ],
        ...
        vec![
            ...
            ("On Secondary Container", &palette.on_secondary_container.default),
        ],
        ...
        vec![
            ...
            ("On Tertiary Container", &palette.on_tertiary_container.default),
        ],
        ...
        vec![
            ("Container Lowest", &palette.surface_container_lowest.default),
            ...
            ("Container Highest", &palette.surface_container_highest.default),
        ],
    ...
    for chunk in cards.chunks(CARDS_PER_ROW) {
        ...
        for color_idx in 0..max_colors {
            ...
            for line_num in 0..3 { // Print 3 lines to make blocks taller
                for (idx, card) in chunk.iter().enumerate() {
                    if color_idx < card.len() {
                        ...
                        let display_content = if line_num == 1 { // Middle line shows text
                        ...
                        let color_block = display_content.on_truecolor(color.red, color.green, color.blue);
                        
                        // Choose text color based on contrast
                        let text_color = if (0.299 * color.red as f64 + 0.587 * color.green as f64 + 0.114 * color.blue as f64) > 128.0 {
